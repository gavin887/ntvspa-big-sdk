...
/**
 * This class stands for RetrieveTravelAgencyRequest Structs
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: tns:RetrieveTravelAgencyRequest | q1:RetrieveTravelAgencyRequest
 *
 * @subpackage Structs
 */
#[AllowDynamicProperties]
class RetrieveTravelAgencyRequest extends AbstractStructBase
{
    /**
     * The SourceSystem
     *
    ...
    /**
     * Constructor method for RetrieveTravelAgencyRequest
     *
     * @param string $sourceSystem
     * @param string $signature
     * @param string $iDPartner
     *
     * @uses RetrieveTravelAgencyRequest::setSourceSystem()
     * @uses RetrieveTravelAgencyRequest::setSignature()
     * @uses RetrieveTravelAgencyRequest::setIDPartner()
     */
     ...
     * @param string $sourceSystem
     *
     * @return RetrieveTravelAgencyRequest
