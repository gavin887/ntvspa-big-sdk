...
/**
 * This class stands for RetrieveAgencyAccountingPDFURLResponse Structs
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: q12:RetrieveAgencyAccountingPDFURLResponse | tns:RetrieveAgencyAccountingPDFURLResponse
 *
 * @subpackage Structs
 */
#[AllowDynamicProperties]
class RetrieveAgencyAccountingPDFURLResponse extends ResponseBase
{
    /**
     * The PdfUrl
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for RetrieveAgencyAccountingPDFURLResponse
     *
     * @param string $pdfUrl
     *
     * @uses RetrieveAgencyAccountingPDFURLResponse::setPdfUrl()
     */
     ...
     * @param string $pdfUrl
     *
     * @return RetrieveAgencyAccountingPDFURLResponse
     */
