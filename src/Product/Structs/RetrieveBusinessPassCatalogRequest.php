...
/**
 * This class stands for RetrieveBusinessPassCatalogRequest Structs
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: q17:RetrieveBusinessPassCatalogRequest | tns:RetrieveBusinessPassCatalogRequest
 *
 * @subpackage Structs
 */
#[AllowDynamicProperties]
class RetrieveBusinessPassCatalogRequest extends AbstractStructBase
{
    /**
     * The SourceSystem
     *
    ...
    /**
     * Constructor method for RetrieveBusinessPassCatalogRequest
     *
     * @param string $sourceSystem
     * @param string $signature
     *
     * @uses RetrieveBusinessPassCatalogRequest::setSourceSystem()
     * @uses RetrieveBusinessPassCatalogRequest::setSignature()
     */
     ...
     * @param string $sourceSystem
     *
     * @return RetrieveBusinessPassCatalogRequest
