...
/**
 * This class stands for RetrieveVoucherAmountResponse Structs
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: q14:RetrieveVoucherAmountResponse | tns:RetrieveVoucherAmountResponse
 *
 * @subpackage Structs
 */
#[AllowDynamicProperties]
class RetrieveVoucherAmountResponse extends ResponseBase
{
    /**
     * The AvailableAmount
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for RetrieveVoucherAmountResponse
     *
     * @param float  $availableAmount
     * @param string $currencyCode
     *
     * @uses RetrieveVoucherAmountResponse::setAvailableAmount()
     * @uses RetrieveVoucherAmountResponse::setCurrencyCode()
     */
     ...
     * @param float $availableAmount
     *
     * @return RetrieveVoucherAmountResponse
     */
