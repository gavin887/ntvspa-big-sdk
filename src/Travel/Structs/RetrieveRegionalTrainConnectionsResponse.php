...
/**
 * This class stands for RetrieveRegionalTrainConnectionsResponse Structs
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: q6:RetrieveRegionalTrainConnectionsResponse | tns:RetrieveRegionalTrainConnectionsResponse
 *
 * @subpackage Structs
 */
#[AllowDynamicProperties]
class RetrieveRegionalTrainConnectionsResponse extends ResponseBase
{
    /**
     * The Operation
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for RetrieveRegionalTrainConnectionsResponse
     *
     * @param Operation                                      $operation
     * @param \Ntvspa\Big\Travel\Arrays\ArrayOfTrainSchedule $trainSchedule
     *
     * @uses RetrieveRegionalTrainConnectionsResponse::setOperation()
     * @uses RetrieveRegionalTrainConnectionsResponse::setTrainSchedule()
     */
     ...
     * @param Operation $operation
     *
     * @return RetrieveRegionalTrainConnectionsResponse
     */
