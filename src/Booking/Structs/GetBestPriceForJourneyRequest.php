...
/**
 * This class stands for GetBestPriceForJourneyRequest Structs
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: q23:GetBestPriceForJourneyRequest | tns:GetBestPriceForJourneyRequest
 *
 * @subpackage Structs
 */
#[AllowDynamicProperties]
class GetBestPriceForJourneyRequest extends AbstractStructBase
{
    /**
     * The SourceSystem
     *
    ...
    /**
     * Constructor method for GetBestPriceForJourneyRequest
     *
     ...
     *
     * @uses GetBestPriceForJourneyRequest::setSourceSystem()
     * @uses GetBestPriceForJourneyRequest::setDepartureDateTime()
     * @uses GetBestPriceForJourneyRequest::setSignature()
     * @uses GetBestPriceForJourneyRequest::setRFITrainNumber()
     * @uses GetBestPriceForJourneyRequest::setNTVTrainNumber()
     * @uses GetBestPriceForJourneyRequest::setDepartureStation()
     * @uses GetBestPriceForJourneyRequest::setArrivalStation()
     */
    public function __construct(?string $sourceSystem = null, ?string $departureDateTime = null, ?string $signature = null, ?string $rFITrainNumber = null, ?string $nTVTrainNumber = null, ?string $departureStation = null, ?string $arrivalStation = null)
    {
        $this
     ...
     * @param string $sourceSystem
     *
     * @return GetBestPriceForJourneyRequest
