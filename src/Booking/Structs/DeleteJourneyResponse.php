...
/**
 * This class stands for DeleteJourneyResponse Structs
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: q14:DeleteJourneyResponse | tns:DeleteJourneyResponse
 *
 * @subpackage Structs
 */
#[AllowDynamicProperties]
class DeleteJourneyResponse extends ResponseBase
{
    /**
     * The BookingSummary
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for DeleteJourneyResponse
     *
     * @param BookingSummary $bookingSummary
     *
     * @uses DeleteJourneyResponse::setBookingSummary()
     */
