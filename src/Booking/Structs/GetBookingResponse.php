...
/**
 * This class stands for GetBookingResponse Structs
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: q10:GetBookingResponse | tns:GetBookingResponse
 *
 * @subpackage Structs
 */
#[AllowDynamicProperties]
class GetBookingResponse extends ResponseBase
{
    /**
     * The Booking
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for GetBookingResponse
     *
     * @param Booking $booking
     *
     * @uses GetBookingResponse::setBooking()
     */
