...
/**
 * This class stands for GetSeatAvailabilityRequest Structs
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: q41:GetSeatAvailabilityRequest | tns:GetSeatAvailabilityRequest
 *
 * @subpackage Structs
 */
#[AllowDynamicProperties]
class GetSeatAvailabilityRequest extends AbstractStructBase
{
    /**
     * The SourceSystem
     *
    ...
    /**
     * Constructor method for GetSeatAvailabilityRequest
     *
     * @param string  $sourceSystem
     * @param string  $signature
     * @param Segment $segment
     *
     * @uses GetSeatAvailabilityRequest::setSourceSystem()
     * @uses GetSeatAvailabilityRequest::setSignature()
     * @uses GetSeatAvailabilityRequest::setSegment()
     */
     ...
     * @param string $sourceSystem
     *
     * @return GetSeatAvailabilityRequest
