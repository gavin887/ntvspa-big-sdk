...
/**
 * This class stands for FindBookingResponse Structs
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: q20:FindBookingResponse | tns:FindBookingResponse
 *
 * @subpackage Structs
 */
#[AllowDynamicProperties]
class FindBookingResponse extends ResponseBase
{
    /**
     * The LastId
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for FindBookingResponse
     *
     * @param int                                       $lastId
     * @param \Ntvspa\Big\Booking\Arrays\ArrayOfBooking $bookings
     *
     * @uses FindBookingResponse::setLastId()
     * @uses FindBookingResponse::setBookings()
     */
