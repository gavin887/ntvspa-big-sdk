...
/**
 * This class stands for OverrideFeeResponse Structs
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: q30:OverrideFeeResponse | tns:OverrideFeeResponse
 *
 * @subpackage Structs
 */
#[AllowDynamicProperties]
class OverrideFeeResponse extends ResponseBase
{
    /**
     * The BookingSummary
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for OverrideFeeResponse
     *
     * @param BookingSummary $bookingSummary
     *
     * @uses OverrideFeeResponse::setBookingSummary()
     */
