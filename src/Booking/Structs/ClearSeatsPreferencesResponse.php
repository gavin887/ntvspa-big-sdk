...
/**
 * This class stands for ClearSeatsPreferencesResponse Structs
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: q56:ClearSeatsPreferencesResponse | tns:ClearSeatsPreferencesResponse
 *
 * @subpackage Structs
 */
#[AllowDynamicProperties]
class ClearSeatsPreferencesResponse extends ResponseBase
{
    /**
     * The BookingSummary
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for ClearSeatsPreferencesResponse
     *
     * @param BookingSummary $bookingSummary
     *
     * @uses ClearSeatsPreferencesResponse::setBookingSummary()
     */
