...
/**
 * This class stands for AssignSeatResponse Structs
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: q36:AssignSeatResponse | tns:AssignSeatResponse
 *
 * @subpackage Structs
 */
#[AllowDynamicProperties]
class AssignSeatResponse extends ResponseBase
{
    /**
     * The BookingSummary
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for AssignSeatResponse
     *
     * @param BookingSummary $bookingSummary
     *
     * @uses AssignSeatResponse::setBookingSummary()
     */
