...
/**
 * This class stands for UpdatePassengersResponse Structs
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: q58:UpdatePassengersResponse | tns:UpdatePassengersResponse
 *
 * @subpackage Structs
 */
#[AllowDynamicProperties]
class UpdatePassengersResponse extends ResponseBase
{
    /**
     * The BookingSummary
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for UpdatePassengersResponse
     *
     * @param BookingSummary $bookingSummary
     *
     * @uses UpdatePassengersResponse::setBookingSummary()
     */
