...
/**
 * This class stands for ManageSSRResponse Structs
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: q16:ManageSSRResponse | tns:ManageSSRResponse
 *
 * @subpackage Structs
 */
#[AllowDynamicProperties]
class ManageSSRResponse extends ResponseBase
{
    /**
     * The BookingSummary
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for ManageSSRResponse
     *
     * @param BookingSummary $bookingSummary
     *
     * @uses ManageSSRResponse::setBookingSummary()
     */
