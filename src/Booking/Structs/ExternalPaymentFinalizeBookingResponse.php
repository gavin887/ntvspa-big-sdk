...
/**
 * This class stands for ExternalPaymentFinalizeBookingResponse Structs
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: q40:ExternalPaymentFinalizeBookingResponse | tns:ExternalPaymentFinalizeBookingResponse
 *
 * @subpackage Structs
 */
#[AllowDynamicProperties]
class ExternalPaymentFinalizeBookingResponse extends ResponseBase
{
    /**
     * The BookingSummary
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for ExternalPaymentFinalizeBookingResponse
     *
     * @param BookingSummary $bookingSummary
     *
     * @uses ExternalPaymentFinalizeBookingResponse::setBookingSummary()
     */
