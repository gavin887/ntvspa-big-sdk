...
/**
 * This class stands for FinalizeBookingResponse Structs
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: q8:FinalizeBookingResponse | tns:FinalizeBookingResponse
 *
 * @subpackage Structs
 */
#[AllowDynamicProperties]
class FinalizeBookingResponse extends ResponseBase
{
    /**
     * The BookingSummary
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for FinalizeBookingResponse
     *
     * @param BookingSummary $bookingSummary
     *
     * @uses FinalizeBookingResponse::setBookingSummary()
     */
