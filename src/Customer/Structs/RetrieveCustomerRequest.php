...
/**
 * This class stands for RetrieveCustomerRequest Structs
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: q15:RetrieveCustomerRequest | tns:RetrieveCustomerRequest
 *
 * @subpackage Structs
 */
#[AllowDynamicProperties]
class RetrieveCustomerRequest extends AbstractStructBase
{
    /**
     * The SourceSystem
     *
    ...
    /**
     * Constructor method for RetrieveCustomerRequest
     *
     * @param string $sourceSystem
     * @param string $signature
     *
     * @uses RetrieveCustomerRequest::setSourceSystem()
     * @uses RetrieveCustomerRequest::setSignature()
     */
