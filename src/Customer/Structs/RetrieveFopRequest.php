...
/**
 * This class stands for RetrieveFopRequest Structs
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: q17:RetrieveFopRequest | tns:RetrieveFopRequest
 *
 * @subpackage Structs
 */
#[AllowDynamicProperties]
class RetrieveFopRequest extends AbstractStructBase
{
    /**
     * The SourceSystem
     *
    ...
    /**
     * Constructor method for RetrieveFopRequest
     *
     * @param string $sourceSystem
     * @param string $signature
     *
     * @uses RetrieveFopRequest::setSourceSystem()
     * @uses RetrieveFopRequest::setSignature()
     */
