...
/**
 * This class stands for GetCustomerContactsRequest Structs
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: q13:GetCustomerContactsRequest | tns:GetCustomerContactsRequest
 *
 * @subpackage Structs
 */
#[AllowDynamicProperties]
class GetCustomerContactsRequest extends AbstractStructBase
{
    /**
     * The SourceSystem
     *
    ...
    /**
     * Constructor method for GetCustomerContactsRequest
     *
     * @param string $sourceSystem
     * @param string $signature
     *
     * @uses GetCustomerContactsRequest::setSourceSystem()
     * @uses GetCustomerContactsRequest::setSignature()
     */
     ...
     * @param string $sourceSystem
     *
     * @return GetCustomerContactsRequest
