...
use Customer\Arrays\ArrayOfLoyaltyTransaction;
use InvalidArgumentException;

/**
 * This class stands for GetLoyaltyPointsResponse Structs
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: tns:GetLoyaltyPointsResponse | q2:GetLoyaltyPointsResponse
 *
 * @subpackage Structs
 */
#[AllowDynamicProperties]
class GetLoyaltyPointsResponse extends ResponseBase
{
    /**
    ...
    /**
     * The LoyaltyTransactions
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * - nillable: true
     *
     * @var \Ntvspa\Big\Customer\Arrays\ArrayOfLoyaltyTransaction|null
     */
    protected ?ArrayOfLoyaltyTransaction $LoyaltyTransactions = null;

    /**
     * Constructor method for GetLoyaltyPointsResponse
     *
     ...
     * @param \Ntvspa\Big\Customer\Arrays\ArrayOfLoyaltyTransaction $loyaltyTransactions
     *
     * @uses GetLoyaltyPointsResponse::setAvailableLoyaltyPoints()
     * @uses GetLoyaltyPointsResponse::setQualifyingPoints()
     * @uses GetLoyaltyPointsResponse::setNextTierGapPoints()
     * @uses GetLoyaltyPointsResponse::setExpirationDate()
     * @uses GetLoyaltyPointsResponse::setAmexCardHolder()
     * @uses GetLoyaltyPointsResponse::setJourneyCompleted()
     * @uses GetLoyaltyPointsResponse::setLoyaltyLevel()
     * @uses GetLoyaltyPointsResponse::setLoyaltyTransactions()
     */
    public function __construct(?int $availableLoyaltyPoints = null, ?int $qualifyingPoints = null, ?int $nextTierGapPoints = null, ?string $expirationDate = null, ?bool $amexCardHolder = null, ?int $journeyCompleted = null, ?string $loyaltyLevel = null, ?ArrayOfLoyaltyTransaction $loyaltyTransactions = null)
    {
        $this
     ...
     * @param int $availableLoyaltyPoints
     *
     * @return GetLoyaltyPointsResponse
     */
    ...
    /**
     * Get LoyaltyTransactions value
     * An additional test has been added (isset) before returning the property value as
     * this property may have been unset before, due to the fact that this property is
     * removable from the request (nillable=true+minOccurs=0)
     *
     * @return \Ntvspa\Big\Customer\Arrays\ArrayOfLoyaltyTransaction|null
     */
    public function getLoyaltyTransactions(): ?ArrayOfLoyaltyTransaction
    {
        return $this->LoyaltyTransactions ?? null;
    }

    /**
     * Set LoyaltyTransactions value
     * This property is removable from request (nillable=true+minOccurs=0), therefore
     * if the value assigned to this property is null, it is removed from this object
     *
     * @param \Ntvspa\Big\Customer\Arrays\ArrayOfLoyaltyTransaction $loyaltyTransactions
     ...
     * @return GetLoyaltyPointsResponse
     */
    public function setLoyaltyTransactions(?ArrayOfLoyaltyTransaction $loyaltyTransactions = null): self
    {
        if (is_null($loyaltyTransactions) || (is_array($loyaltyTransactions) && empty($loyaltyTransactions))) {
            unset($this->LoyaltyTransactions);
        } else {
