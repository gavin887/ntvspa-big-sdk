...
use Customer\Arrays\ArrayOfAdditionalMessage;
use InvalidArgumentException;
use Ntvspa\Big\Customer\Enums\BIGExceptionType;
...
class ExceptionInfo extends AbstractStructBase
{
     ...
     * - nillable: true
     *
     * @var \Ntvspa\Big\Customer\Arrays\ArrayOfAdditionalMessage|null
     */
     ...
     * @param \Ntvspa\Big\Customer\Arrays\ArrayOfAdditionalMessage $additionalMessages
     ...
     * @uses \Ntvspa\Big\Customer\Enums\BIGExceptionType::getValidValues()
     * @uses \Ntvspa\Big\Customer\Enums\BIGExceptionType::valueIsValid()
     */
    public function setType(?string $type = null): self
    {
        // validation for constraint: enumeration
        if (!\Ntvspa\Big\Customer\Enums\BIGExceptionType::valueIsValid($type)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Ntvspa\Big\Customer\Enums\BIGExceptionType', is_array($type) ? implode(', ', $type) : var_export($type, true), implode(', ', BIGExceptionType::getValidValues())), __LINE__);
        }
        $this->Type = $type;
     ...
     * removable from the request (nillable=true+minOccurs=0)
     *
     * @return \Ntvspa\Big\Customer\Arrays\ArrayOfAdditionalMessage|null
     */
