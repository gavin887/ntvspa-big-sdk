...
/**
 * This class stands for DeleteCustomerProfileResponse Structs
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: q24:DeleteCustomerProfileResponse | tns:DeleteCustomerProfileResponse
 *
 * @subpackage Structs
 */
#[AllowDynamicProperties]
class DeleteCustomerProfileResponse extends ResponseBase
{
    /**
     * The AcquiredRequest
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for DeleteCustomerProfileResponse
     *
     * @param bool $acquiredRequest
     *
     * @uses DeleteCustomerProfileResponse::setAcquiredRequest()
     */
