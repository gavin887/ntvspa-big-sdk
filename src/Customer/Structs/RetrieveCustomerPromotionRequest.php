...
/**
 * This class stands for RetrieveCustomerPromotionRequest Structs
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: q3:RetrieveCustomerPromotionRequest | tns:RetrieveCustomerPromotionRequest
 *
 * @subpackage Structs
 */
#[AllowDynamicProperties]
class RetrieveCustomerPromotionRequest extends AbstractStructBase
{
    /**
     * The SourceSystem
     *
    ...
    /**
     * Constructor method for RetrieveCustomerPromotionRequest
     *
     * @param string $sourceSystem
     * @param string $signature
     *
     * @uses RetrieveCustomerPromotionRequest::setSourceSystem()
     * @uses RetrieveCustomerPromotionRequest::setSignature()
     */
     ...
     * @param string $sourceSystem
     *
     * @return RetrieveCustomerPromotionRequest
