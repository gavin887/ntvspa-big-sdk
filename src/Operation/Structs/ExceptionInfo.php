...
use Ntvspa\Big\Operation\Enums\BIGExceptionType;
use Operation\Arrays\ArrayOfAdditionalMessage;
...
class ExceptionInfo extends AbstractStructBase
{
     ...
     * - nillable: true
     *
     * @var \Ntvspa\Big\Operation\Arrays\ArrayOfAdditionalMessage|null
     */
     ...
     * @param \Ntvspa\Big\Operation\Arrays\ArrayOfAdditionalMessage $additionalMessages
     ...
     * @uses \Ntvspa\Big\Operation\Enums\BIGExceptionType::getValidValues()
     * @uses \Ntvspa\Big\Operation\Enums\BIGExceptionType::valueIsValid()
     */
    public function setType(?string $type = null): self
    {
        // validation for constraint: enumeration
        if (!\Ntvspa\Big\Operation\Enums\BIGExceptionType::valueIsValid($type)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Ntvspa\Big\Operation\Enums\BIGExceptionType', is_array($type) ? implode(', ', $type) : var_export($type, true), implode(', ', BIGExceptionType::getValidValues())), __LINE__);
        }
        $this->Type = $type;
     ...
     * removable from the request (nillable=true+minOccurs=0)
     *
     * @return \Ntvspa\Big\Operation\Arrays\ArrayOfAdditionalMessage|null
     */
