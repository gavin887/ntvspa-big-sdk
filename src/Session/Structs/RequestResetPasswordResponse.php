...
/**
 * This class stands for RequestResetPasswordResponse Structs
 * Meta information extracted from the WSDL
 * - nillable: true
 * - type: q10:RequestResetPasswordResponse | tns:RequestResetPasswordResponse
 *
 * @subpackage Structs
 */
#[AllowDynamicProperties]
class RequestResetPasswordResponse extends AbstractStructBase
{
    /**
     * The AcquiredRequest
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for RequestResetPasswordResponse
     *
     * @param bool                                      $acquiredRequest
     * @param \Ntvspa\Big\Session\Arrays\ArrayOfWarning $warnings
     *
     * @uses RequestResetPasswordResponse::setAcquiredRequest()
     * @uses RequestResetPasswordResponse::setWarnings()
     */
